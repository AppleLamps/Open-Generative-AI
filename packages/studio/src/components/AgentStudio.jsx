  ...
  return (
    <div className="group relative aspect-4/5 rounded-xl cursor-pointer">
      <div
        ...
        className="absolute inset-0 rounded-xl overflow-hidden border border-white/5 bg-panel-bg transition-all group-hover:border-primary/30 group-hover:scale-[1.02] shadow-2xl"
      >
        {agent.icon_url ? (
          <img
            src={agent.icon_url}
          ...
          <div className="absolute inset-0 bg-linear-to-br from-violet-500/10 to-fuchsia-500/10 flex items-center justify-center">
...
function ConversationCard({ conv, onClick }) {
  ...
  return (
    <div
      ...
      className="group flex flex-col gap-3 bg-white/3 border border-white/5 rounded-xl p-4 hover:border-primary/20 hover:bg-white/5 transition-all cursor-pointer"
    >
...
export default function AgentStudio({ apiKey }) {
  ...
  return (
    <div className="h-full flex flex-col bg-[#030303] text-white">
      {/* Header */}
      <div className="shrink-0 h-16 border-b border-white/5 flex items-center justify-between px-8 bg-black/40">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-8">
        {loading ? (
          ...
          conversations.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-400 mx-auto">
          ...
          agents.length === 0 ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-6 max-w-400 mx-auto">
              {agents.map((agent) => (
                <AgentCard
